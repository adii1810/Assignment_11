...
class view5: UIViewController {
        ...
        var array = [Noticeclass]()
        
        override func viewWillAppear(_ animated: Bool) {
            super.viewWillAppear(animated)
            
            array = sqlHandler.shared.noticeFetch()
        ...
        override func viewDidLoad() {
            ...
            navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(addNoticeFunc))
        ...
        @objc private func addNoticeFunc(){
            let vc = addNotice()
    ...
    extension view5: UITableViewDelegate,UITableViewDataSource{
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            cell.textLabel?.text = "\(data.title)|\(data.notice)|\(data.date)"
            return cell
        }
        ...
        func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
            ...
            sqlHandler.shared.noticeDelete(for: id){ success in
                if success{
